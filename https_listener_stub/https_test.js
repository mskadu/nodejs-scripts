...
// General stuff
let	configOutputDir 	= config.output 		|| 	'data/output',
	configReqLimit		= config.reqLimit 		||	'1024',
	configPort			= config.port			||	'8671',
	configLogCallbacks	= config.log_callbacks	||	false;
